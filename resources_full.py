...
hgatebit_w = Image.open("gates.png").crop((5618,71,5709,46)).convert("RGBA") # H gate bit - white world
hgatebit_w = hgatebit_w.resize(list(map(lambda x:x//2 , hgatebit_w.size)))

hgatebit_b = Image.open("gates.png").crop((5371,194,5709,111)).convert("RGBA") # H gate bit - black world
